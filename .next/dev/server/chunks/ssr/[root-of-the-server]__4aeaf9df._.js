...
"[project]/src/lib/url.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$url$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/url.ts [app-rsc] (ecmascript)");
;
...
async function fetchPreorders({ filter = "ALL", sortBy = "createdAt", sortOrder = "desc", page = "1" } = {}) {
    ...
    const response = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$url$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAbsoluteUrl"])(`/api/preorders?${query.toString()}`), {
        cache: "no-store"
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4aeaf9df._.js.map